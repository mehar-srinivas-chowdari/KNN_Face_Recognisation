...
def train(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=True):
    ...
    for class_dir in os.listdir(train_dir):
        ...
        for img_path in image_files_in_folder(os.path.join(train_dir, class_dir)):
            ...
            img = Image.open(img_path)  ######### OWN
            face_bounding_boxes=[(0,img.width,img.height,0)]  ######## OWN
...
def show_prediction_labels_on_image(img_path, predictions, img_save_path):
    ...
    # pil_image.show()
    pil_image.save(img_save_path + "image" + str(randint(1, 1000)) + str(randint(1,1000))+ ".jpg")
